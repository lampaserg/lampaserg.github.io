...
(function() {
    ...
    // =================================================================
    // SVG ИКОНКИ ДЛЯ МЕТАДАННЫХ (как в Ліхтар Studios2)
    // =================================================================
        ...
        try {
            ...
            if (badgesContainer.length && qualityData) {
                ...
                if (qualityData.resolution && qualityData.resolution !== 'SD') {
                    ...
                    if (icon) {
                        badgesContainer.append('<span class="quality-badge quality-badge--icon">' + icon + '</span>');
                    } else {
                        var resClass = 'quality-badge--' + resLabel.toLowerCase().replace(/ /g, '');
